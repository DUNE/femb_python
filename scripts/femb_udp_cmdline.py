...
class FEMB_UDP:
    ...
    #
        ...
        dataVal = int(data)
#        print ("femb_udp_cmdline.py -> write reg " + str(reg) + " -> dataVal_binary " + str(bin(dataVal)))
...
#        sock_write.bind((settings.PC_IP, 32000))
    ...
    def init_ports(self, hostIP = '', destIP = '', dummy_port = 0):
        #
        # init_ports()
        #       Sends a dummy packet from the PC to an FPGA port in order to 
        #       initiate an ARP request and map the FPGA port.
        #   procedure:
        #       line 267: format packet
        #       line 270: open UDP channel via IPv4
        #       line 272: set socket opt to keep channel open
        #       line 275: define client addr & port
        #       line 276: write message
        #
