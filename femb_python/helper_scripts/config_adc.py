...
def main():
    ...
    parser.add_argument("--pdsr",help="Set pdsr",type=int,choices=[0,1],default=0)
    parser.add_argument("--pcsr",help="Set pcsr",type=int,choices=[0,1],default=0)
    ...
    parser.add_argument("--clockFromFIFO",help="Use FIFO digital generator for ADC clock",action='store_true')
    ...
    parser.add_argument("--f2",help="Set f2",type=int,choices=[0,1],default=0)
    ...
    femb_config.configAdcAsic(enableOffsetCurrent=enableOffsetCurrent,offsetCurrent=offsetCurrent,testInput=testInput,
                            ...
                            clockMonostable=args.clockMonostable,clockExternal=args.clockExternal,clockFromFIFO=args.clockFromFIFO,
