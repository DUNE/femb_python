...
def show_trace_root(infilename,sampleMax=None,fullADCRange=False,showFFT=True):
...
def main():
    ...
    try:
        show_trace_root(args.infilename,args.sampleMax,args.fullADCRange,not args.dontShowFFT)
