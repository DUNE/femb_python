...
class FEMB_TEST_GAIN_EXTERNALDAC(object):
    ...
    def do_analysis(self):
        ...
        self.cppfr.run("test_measurements/feAsicTest/processNtuple_gainMeasurement_externaldac",  [parseBinaryFile])

        processNtupleFile = self.outpathlabel + "-processNtupleFile.root"
        call(["mv", "output_processNtuple_gainMeasurement_externaldac.root" , processNtupleFile])

        summaryPlot = self.outpathlabel + "-summaryPlot.png"
        call(["mv", "summaryPlot_gainMeasurement_externaldac.png" , summaryPlot])

        resultsFile = self.outpathlabel + "-results.list"
        call(["mv", "output_processNtuple_gainMeasurement_externaldac.list" , resultsFile])
...
def main():
    ...
    ftg = FEMB_TEST_GAIN_EXTERNALDAC(datadir, outlabel)
