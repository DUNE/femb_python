//compile independently with: g++ -std=c++11 -o processNtuple_gainMeasurement_externaldac processNtuple_gainMeasurement_externaldac.cxx `root-config --cflags --glibs`
#include <iostream>
#include <fstream>
#include <sstream>
#include <cstdlib>
...
Analyze::Analyze(std::string inputFileName){
	...
	//make output file
  	std::string outputFileName = "output_processNtuple_gainMeasurement_externaldac.root";
...
void Analyze::outputResults(){
	...
	//output to file here:
  	std::string outputFileName = "output_processNtuple_gainMeasurement_externaldac.list";
	...
	imgstream << "summaryPlot_gainMeasurement_externaldac.png";
