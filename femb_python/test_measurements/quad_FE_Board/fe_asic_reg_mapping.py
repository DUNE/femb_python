from femb_python.test_measurements.sbnd_femb_test.fe_info import FE_INFO
...
####sec_sbnd_board sets registers of a whole board 
    ...
    #__INIT__#
    def __init__(self):
        #declare default registers
        self.REGS =[0xD1D1D1D1, 0xD1D1D1D1, 0xD1D1D1D1, 0xD1D1D1D1, 0x0000C100,
