...
class FEMB_UDP:
    ...
    def write_reg(self, reg, data):
        ...
        sock_write.sendto(WRITE_MESSAGE,(self.FPGA_IP, self.PORT_WREG ))
...
#        print ("FEMB_UDP--> Write: reg=%x,value=%x"%(reg,data))
    ...
    def read_reg(self, reg):
        ...
        for i in range(10):
            ...
            sock_readresp.bind((self.PC_IP, self.PORT_RREGRESP ))
            ...
            sock_read.sendto(READ_MESSAGE,(self.FPGA_IP,self.PORT_RREG))
