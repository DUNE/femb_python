...
class FEMB_TEST:
    ...
    def check_setup(self):
        ...
        # regVal = self.femb_config.femb.read_reg(0x800)
        ...
        #     return
        # print("Read register 0x800, value = " + str( hex( regVal ) ) )
...
def main():
    ...
    femb_test = FEMB_TEST()
    #femb_test.femb_config.selectFemb(0) - only do this with FEMB in setup
