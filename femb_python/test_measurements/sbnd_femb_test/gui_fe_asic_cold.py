...
class GUI_WINDOW(tk.Frame):
    ...
    def define_general_commands_column(self):
        ...
        self.save_results_button = tk.Button(self, text="Save Sync Results", bg="green", command=self.save_sync_results_function ,width=25)
...
#                       "baseline_test_sequence"]:
            ...
            gui_label = self.method + "_result"
            gui_label["text"] = LOUD + " - IN PROGRESS"
            self.update_idletasks()
